 ...
 */
   ...
   //Checks to see if two skier objects are equivalent.  They are equivalent if they have the same name
   ...
   //provides a string representation of a skier that species a name and a level.  Ex. Jane Doe (level 0)
